...
```
variableGroups: 
    - coreai-mcu-document-processor-snd1
    - coreai-mcu-document-processor-snd2
    - coreai-mcu-document-processor-snd3
variables:
    - coreai-mcu-document-processor-APPINSIGHTS-CONNECTIONSTRING
```
